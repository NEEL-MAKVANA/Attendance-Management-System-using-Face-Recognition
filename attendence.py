...
class Attendence:
    def __init__(self,root):
        ...
        # 1st image
        img=Image.open(r"C:\Users\DIYA\Desktop\ML Project\Images\new13.jpg")
        img=img.resize((800,200)) #ANTILIAS - converts high level image to low level image
        ...
        # 2nd image
        img1=Image.open(r"C:\Users\DIYA\Desktop\ML Project\Images\new14.jpg")
        img1=img1.resize((800,200)) #ANTILIAS - converts high level image to low level image
        ...
        img_left=Image.open(r"C:\Users\DIYA\Desktop\ML Project\Images\new12.PNG")
        ...
        delete_btn = Button(btn_frame, text="Delete",command=self.delete,width=19,font=("times new roman",12,"bold"),bg="blue",fg="white")
    ...
    def delete(self,event=""):
        ...
        with open('universal.csv', 'r') as readFile:
            ...
            for row in reader:
                ...
                for field in row:
                    if field == id:
                        lines.remove(row)
        with open('universal.csv', 'w') as writeFile:
