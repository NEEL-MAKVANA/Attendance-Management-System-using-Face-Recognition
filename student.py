...
class Student:
    def __init__(self,root):
        ...
        # First image
        img=Image.open(r"C:\Users\DIYA\Desktop\ML Project\Images\student_details.jpg")
        img=img.resize((500,130)) #ANTILIAS - converts high level image to low level image
        ...
        img1=img1.resize((500,130)) #ANTILIAS - converts high level image to low level image
        ...
        # Third image
        img2=Image.open(r"C:\Users\DIYA\Desktop\ML Project\Images\student4.jpg")
        img2=img2.resize((500,130)) #ANTILIAS - converts high level image to low level image
        ...
        img3=img3.resize((1530,710)) #ANTILIAS - converts high level image to low level image
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root, image=self.photoimg3)
        bg_img.place(x=0,y=130,width=1530,height=710)

        title_lbl=Label(bg_img, text="Student's Details Management",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
        ...
        img_left=Image.open(r"C:\Users\DIYA\Desktop\ML Project\Images\students1.jpg")
        img_left=img_left.resize((720,130)) #ANTILIAS - converts high level image to low level image
        ...
        dep_combo["values"]=("Select Deprtment","Computer","IT","Civil","Mechanical")
        dep_combo.current(0)
        ...
        # course_combo["values"]=("Select Course","ML","CN","NIS","TAFL")
        ...
        div_combo = ttk.Combobox(class_student_frame,textvariable=self.var_div, font=("times new roman",12,"bold"), state="read only", width=19)
        ...
        gender_combo = ttk.Combobox(class_student_frame,textvariable=self.var_gender, font=("times new roman",12,"bold"), state="read only", width=19)
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,width=39, text="Take Photo Sample",font=("times new roman",12,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0, column=0)

        update_photo_btn=Button(btn_frame1,width=38, text="Upadte Photo Sample",font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\DIYA\Desktop\ML Project\Images\students2.jpg")
        img_right=img_right.resize((720,130)) #ANTILIAS - converts high level image to low level image
        ...
        search_combo["values"]=("Select","Roll No","Email")
        ...
        self.student_table = ttk.Treeview(table_frame, column=("dep","year","sem","id","name","div","roll","gender","dob","email","phone","address","photo"),xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)

        scroll_x.pack(side=BOTTOM, fill=X)
        scroll_y.pack(side=RIGHT, fill=Y)
        scroll_x.config(command=self.student_table.xview)
        scroll_y.config(command=self.student_table.yview)
        # config or configure is used to access an object's attributes after its initialisation.
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="localhost", username="root",database="face_recognition")
                my_cursor = conn.cursor()
                my_cursor.execute("insert into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.var_dep.get(),
                                                                                                            self.var_year.get(),
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn = mysql.connector.connect(host="localhost", username="root",database="face_recognition")
                    my_cursor = conn.cursor()
                    my_cursor.execute("Update student set Dep=%s, Year=%s, Semester=%s,name=%s, Division=%s, roll=%s, gender=%s, DOB=%s, Email=%s, Phone=%s, Address=%s, PhotoSample=%s where Student_id=%s", (
                                                                                                                self.var_dep.get(),
                                                                                                                self.var_year.get(),
                                                                                                                self.var_semester.get(),
                                                                                                                self.var_std_name.get(),
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            ...
            try:
                delete=messagebox.askyesno("Student Delete page","Do you wannt to delete this student", parent=self.root)
                if delete>0:
                    conn = mysql.connector.connect(host="localhost", username="root",database="face_recognition")
                    my_cursor=conn.cursor()
                    sql="delete from student where Student_id=%s"
                    val=(str(self.var_std_id.get()),)
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                face_classifier = cv2.CascadeClassifier(r"C:\Users\DIYA\Desktop\ML Project\Classsifier\haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        # (450,450) indicates size of the frame
                        face = cv2.cvtColor(face, cv2.COLOR_BGR2GRAY)
                        file_name_path = r"C:\Users\DIYA\Desktop\ML Project\data\user."+str(id)+"."+str(img_id)+".jpg"
